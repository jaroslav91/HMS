...
{
    public class HousingManagementSystemDbContext: DbContext
    {
        private readonly ILoggedInUserService _loggedInUserService;

        public HousingManagementSystemDbContext(DbContextOptions<HousingManagementSystemDbContext> options)
           : base(options)
        {
        }

        public HousingManagementSystemDbContext(DbContextOptions<HousingManagementSystemDbContext> options, ILoggedInUserService loggedInUserService)
            : base(options)
        {
        ...
        {
            modelBuilder.ApplyConfigurationsFromAssembly(typeof(HousingManagementSystemDbContext).Assembly);
            ...
            modelBuilder.Entity<Event>().HasData(new Event
            {
                ...
                ImageUrl = "https://gillcleerenpluralsight.blob.core.windows.net/files/CompanyName/banjo.jpg",
                CategoryId = concertGuid
            });
            ...
            modelBuilder.Entity<Event>().HasData(new Event
            {
                ...
                ImageUrl = "https://gillcleerenpluralsight.blob.core.windows.net/files/CompanyName/michael.jpg",
                CategoryId = concertGuid
            });
            ...
            modelBuilder.Entity<Event>().HasData(new Event
            {
                ...
                ImageUrl = "https://gillcleerenpluralsight.blob.core.windows.net/files/CompanyName/dj.jpg",
                CategoryId = concertGuid
            });
            ...
            modelBuilder.Entity<Event>().HasData(new Event
            {
                ...
                ImageUrl = "https://gillcleerenpluralsight.blob.core.windows.net/files/CompanyName/guitar.jpg",
                CategoryId = concertGuid
            });
            ...
            modelBuilder.Entity<Event>().HasData(new Event
            {
                ...
                ImageUrl = "https://gillcleerenpluralsight.blob.core.windows.net/files/CompanyName/conf.jpg",
                CategoryId = conferenceGuid
            });
            ...
            modelBuilder.Entity<Event>().HasData(new Event
            {
                ...
                ImageUrl = "https://gillcleerenpluralsight.blob.core.windows.net/files/CompanyName/musical.jpg",
                CategoryId = musicalGuid
            });
