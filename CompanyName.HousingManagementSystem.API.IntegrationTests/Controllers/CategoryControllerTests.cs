using CompanyName.HousingManagementSystem.Api;
using CompanyName.HousingManagementSystem.API.IntegrationTests.Base;
...
namespace CompanyName.HousingManagementSystem.API.IntegrationTests.Controllers
{
