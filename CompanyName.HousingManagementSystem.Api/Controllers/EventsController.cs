...
using CompanyName.HousingManagementSystem.Application.Features.Events.Commands.DeleteEvent;
...
namespace CompanyName.HousingManagementSystem.Api.Controllers
{
    [ApiController]
